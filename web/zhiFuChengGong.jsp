...
<div class="container mar-top-10 mar-bottom-10">
    <div class="row ">
        <div class="col-md-5"><img src="img/logo2.png" width="210" height="70" alt="系统LOGO"
...
<div class="container bg-white box-shadow pad-15 mar-bottom-30" style=" position:relative;">
    <!-- 支付提示 -->
    <div class="tishibox">
        <p class="title">您已支付${Money}</p>
        <p>您可以继续操作：<a href="dinDanLieBiao.jsp">[查看我的订单]</a> <a href="chaXunLieBiao.jsp">[返回首页]</a></p>
        <div class="img_fudong"><a href="#"><img src="img/chenggong2.gif" width="50" height="50"
                                                 border="0"/></a></div>
...
<div id="contact-info" style="display:none">
    ...
    <div class="modal-footer ">
        <label class="mar-right-30" style=" font-weight:normal;"><input name="" type="checkbox" value="" checked>
            下次继续使用该联系人</label>

        <button type="button" class="btn btn-primary" onClick="layer.closeAll()">确 定</button>
...
n
    ...
    <div class="modal-footer mar-top-5">
        ...
        <button type="button" class="btn btn-primary" onClick="layer.closeAll()">返回，核实保险</button>
        <button type="button" class="btn btn-default" onClick="location.href='支付.html'">没有问题，继续下一步</button>
    </div>
</div>
