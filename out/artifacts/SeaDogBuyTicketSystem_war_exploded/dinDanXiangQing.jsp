...
<nav class="navbar navbar-default navbar-fixed-top bg-white" >
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class=" " href="差旅报告/汇总.html" ><img src="img/logo2.png" width="210" height="70" alt="系统LOGO" class="pull-left mar-right-30" style="margin-left:-15px;" ></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li  ><a href="chaXunLieBiao.jsp"><i class="icon iconfont icon-nav-block font24" >&#xe620;</i> 在线预订</a></li>
                <li class="active"><a href="dinDanLieBiao.jsp"><i class="icon iconfont icon-nav-block font24" >&#xe61c;</i> 订单管理</a></li>
...
<div class="container bg-gray-eee box-shadow mar-bottom-30" style="padding-right:0px; padding-left:0px; position:relative; margin-top:120px;">
    ...
    <div class="rightCon">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="dinDanLieBiao.jsp">订单列表</a></li>
            <li class="active"><a href="dinDanXiangQing.jsp">订单详情</a></li>
        </ol>
        <!-- 引导结束 -->
